...
-I have stored here the Capstone project for Python & the following are its contents:
Usage of the various functions from Python libraries NumPy and Pandas to complete the assigned tasks below:
### Task 1 
